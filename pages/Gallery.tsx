...
type Category = 'All' | 'Portrait' | 'Editorial' | 'Fashion';

const categories: Category[] = ['All', 'Portrait', 'Editorial', 'Fashion'];
...
const images: { src: string; category: Category }[] = [
  ...
  { src: 'https://i.pinimg.com/1200x/2c/8d/f5/2c8df52cbf3f21bb2e411cccfe35e5b2.jpg', category: 'Editorial' },
  ...
  { src: 'https://i.pinimg.com/1200x/f8/73/fd/f873fd915463d28916a78a9c8fde08eb.jpg', category: 'Fashion' },
  ...
  return (
    <section className={sectionClasses}>
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between md:gap-10 mb-8">
          <div>
            ...
            <p className="text-xs md:text-sm font-medium tracking-[0.18em] uppercase mb-3">
              ...
              <div className="mt-4 md:mt-0 flex items-center gap-2 md:gap-3 flex-nowrap overflow-x-auto whitespace-nowrap -mx-2 px-2 cat-row">
        ...
        {/* Scoped styles to hide horizontal scrollbar on the filter row while keeping scroll gestures */}
        <style>{`
